...
class motor_Code(QWidget):
	...
	def initUI(self):
		...
		self.scienceButton = QPushButton(self)
		self.scienceButton.setGeometry(QtCore.QRect(85, 0, 85, 16))
		self.scienceButton.setObjectName("scienceButton")
		self.scienceButton.setText("Science")
		self.scienceButton.clicked.connect(self.startSciThread)
		self.closeButton = QPushButton(self)
		self.closeButton.setObjectName("closeButton")
		self.closeButton.setText("Close")
		self.closeButton.setGeometry(QtCore.QRect(170, 0, 85, 16))
